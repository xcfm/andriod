...
import fmz.example.bean.JcodeInfo;
import fmz.example.presenter.FragmentPresenter;
import fmz.example.utils.DataUtil;
import fmz.example.view.ContentListView;
import fmz.example.views.PullLoadMoreRecyclerView;
